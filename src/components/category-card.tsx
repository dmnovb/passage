...
function CategoryCard({ label, emoji }: CategoryCardProps) {
    return (
        <button className="group relative overflow-hidden rounded-xl bg-card border border-border p-6 text-left transition-all hover:shadow-lg hover:shadow-primary/5 hover:border-primary/30 hover:-translate-y-0.5">
